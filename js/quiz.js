...
function next(question,direction) {
    ...
    switch (question) {
        ...
        case 'question1':
            ...
            q_button.innerHTML = "<div class=\"button-q4\">  <button onclick=\"next('question2','forward'); \" class=\"input-btn\">Далее</button></div>";
...
function  q_main_content_generator() {
    ...
    var content_n4;
    var content_n5 = "</div>";
    var content_n6 = "<div class=\"row4\"><label><div class=\"textRow4\"> <input type=\"radio\" class=\"option-input radio\" name=\"example\"  value=\"yourVariant\"/>Ваш вариант</div><div class=\"inputRow4\"><input type=\"text\" id=\"inputText\"></div></label></div>";
    var content = "";
    for (var i = 0; i <= 7; i++) {
